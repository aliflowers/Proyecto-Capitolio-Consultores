...
/**
 * Script de configuración rápida del entorno de desarrollo local
...
async function main() {
  try {
    log('\n🚀 Nexus Jurídico - Configuración Rápida del Entorno Local\n', 'info');
    ...
    log('\n🎉 ¡Configuración rápida completada exitosamente!', 'success');
    log('\n📊 Resumen:', 'info');
    ...
    log(`\n❌ Error fatal durante la configuración: ${error.message}`, 'error');
    process.exit(1);
  }
}
