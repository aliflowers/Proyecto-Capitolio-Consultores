...
async function testDatabase() {
  ...
  try {
    ...
    console.log('Usuarios encontrados:', result.rows[0]);
  } catch (error) {
  ...
  try {
    ...
    console.error('Error en consulta de perfiles:', error.message);
  }
  ...
  try {
    ...
    console.error('Error en consulta de documentos:', error.message);
  }
